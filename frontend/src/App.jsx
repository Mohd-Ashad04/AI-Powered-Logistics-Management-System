...
function AuthScreen({ onLogin, onRegister }) {
  ...
  const handleSubmit = async (event) => {
    ...
    const registerValues = {
      ...
      phone: DEFAULT_REGISTRATION_PHONE,
...
export default function App() {
  ...
  if (!customer) {
    return <><AuthScreen onLogin={handleLogin} onRegister={handleRegister} /><ToastContainer /></>;
  }
  ...
  return (
    <div className="app" onClick={() => showNotifs && setShowNotifs(false)}>
      ...
      <Sidebar
        ...
        customer={customer}
      />
      <div className={`main-wrapper ${sidebarCollapsed ? "main-wrapper--expanded" : ""}`}>
        <Navbar
          showNotifs={showNotifs}
          setShowNotifs={(v) => { v && (document.activeElement.blur()); setShowNotifs(v); }}
          customer={customer}
